...
export type RateLimitErrorCodeEnum =
  (typeof RateLimitErrorCodeEnum)[keyof typeof RateLimitErrorCodeEnum];
 ...
 * @export
 */
export const CongressApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    getMemberCosponsoredLegislation: async (
      bioguideId: string,
      offset?: number,
      limit?: number,
      ...
      const localVarPath =
        `/member/{bioguideId}/cosponsored-legislation`.replace(
          `{${"bioguideId"}}`,
          encodeURIComponent(String(bioguideId)),
        );
    ...
    getMemberDetails: async (
      ...
      const localVarPath = `/member/{bioguideId}`.replace(
        `{${"bioguideId"}}`,
        encodeURIComponent(String(bioguideId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getMemberSponsoredLegislation: async (
      bioguideId: string,
      offset?: number,
      limit?: number,
      options: RawAxiosRequestConfig = {},
      ...
      const localVarPath = `/member/{bioguideId}/sponsored-legislation`.replace(
        `{${"bioguideId"}}`,
        encodeURIComponent(String(bioguideId)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getMembersByCongress: async (
      ...
      const localVarPath = `/member/congress/{congress}`.replace(
        `{${"congress"}}`,
        encodeURIComponent(String(congress)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
    ...
    getMembersByState: async (
      ...
      const localVarPath = `/member/{stateCode}`.replace(
        `{${"stateCode"}}`,
        encodeURIComponent(String(stateCode)),
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
     ...
     * @throws {RequiredError}
     */
    getMembersByStateAndDistrict: async (
      stateCode: string,
      district: string,
      offset?: number,
      limit?: number,
  ...
  return {
    ...
    async getMemberCosponsoredLegislation(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<MemberCosponsoredLegislationResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getMemberCosponsoredLegislation(
          bioguideId,
          offset,
          limit,
          options,
      ...
      const localVarOperationServerBasePath =
        operationServerMap["CongressApi.getMemberCosponsoredLegislation"]?.[
    ...
    async getMemberDetails(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<CongressMemberDetailsResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getMemberDetails(bioguideId, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CongressApi.getMemberDetails"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    async getMemberSponsoredLegislation(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<MemberSponsoredLegislationResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getMemberSponsoredLegislation(
          bioguideId,
          offset,
          limit,
          options,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CongressApi.getMemberSponsoredLegislation"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CongressApi.getMembers"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getMembersByCongress(
          congress,
          offset,
          limit,
          fromDateTime,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CongressApi.getMembersByCongress"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getMembersByState(
          stateCode,
          offset,
          limit,
          fromDateTime,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CongressApi.getMembersByState"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getMembersByStateAndDistrict(
          stateCode,
          district,
          offset,
          limit,
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["CongressApi.getMembersByStateAndDistrict"]?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const CongressApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
     ...
     */
    getMemberCosponsoredLegislation(
      requestParameters: CongressApiGetMemberCosponsoredLegislationRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<MemberCosponsoredLegislationResponse> {
      return localVarFp
        .getMemberCosponsoredLegislation(
          requestParameters.bioguideId,
     ...
     */
    getMemberDetails(
      requestParameters: CongressApiGetMemberDetailsRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<CongressMemberDetailsResponse> {
      return localVarFp
        .getMemberDetails(requestParameters.bioguideId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     * Get a list of legislation sponsored by a member. Supports query parameters for pagination.
     ...
     */
    getMemberSponsoredLegislation(
      requestParameters: CongressApiGetMemberSponsoredLegislationRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<MemberSponsoredLegislationResponse> {
      return localVarFp
        .getMemberSponsoredLegislation(
     ...
     */
    getMembers(
      requestParameters: CongressApiGetMembersRequest = {},
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<CongressMemberListResponse> {
      return localVarFp
        .getMembers(
    ...
    getMembersByCongress(
      requestParameters: CongressApiGetMembersByCongressRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<CongressMemberListResponse> {
      return localVarFp
        .getMembersByCongress(
     ...
     */
    getMembersByState(
      requestParameters: CongressApiGetMembersByStateRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<CongressMemberListResponse> {
      return localVarFp
        .getMembersByState(
     ...
     * @throws {RequiredError}
     */
    getMembersByStateAndDistrict(
      requestParameters: CongressApiGetMembersByStateAndDistrictRequest,
      options?: RawAxiosRequestConfig,
    ): AxiosPromise<CongressMemberListResponse> {
      return localVarFp
        .getMembersByStateAndDistrict(
...
export class CongressApi extends BaseAPI {
   ...
   */
  public getMemberCosponsoredLegislation(
    requestParameters: CongressApiGetMemberCosponsoredLegislationRequest,
    options?: RawAxiosRequestConfig,
  ) {
   ...
   * @memberof CongressApi
   */
  public getMemberSponsoredLegislation(
    requestParameters: CongressApiGetMemberSponsoredLegislationRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return CongressApiFp(this.configuration)
   ...
   * @memberof CongressApi
   */
  public getMembersByStateAndDistrict(
    requestParameters: CongressApiGetMembersByStateAndDistrictRequest,
    options?: RawAxiosRequestConfig,
  ) {
    return CongressApiFp(this.configuration)
