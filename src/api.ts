...
export const CongressApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Get congress member list by congress number. Supports query parameters for filtering. 
         ...
         * @throws {RequiredError}
         */
        getMembersByCongress: async (congress: number, offset?: number, limit?: number, fromDateTime?: string, toDateTime?: string, currentMember?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'congress' is not null or undefined
            assertParamExists('getMembersByCongress', 'congress', congress)
            const localVarPath = `/member/congress/{congress}`
         ...
         * @throws {RequiredError}
         */
        getMembersByState: async (stateCode: string, offset?: number, limit?: number, fromDateTime?: string, toDateTime?: string, currentMember?: boolean, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'stateCode' is not null or undefined
            assertParamExists('getMembersByState', 'stateCode', stateCode)
            const localVarPath = `/member/{stateCode}`
...
export const CongressApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getMembersByCongress(congress: number, offset?: number, limit?: number, fromDateTime?: string, toDateTime?: string, currentMember?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CongressMemberListResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMembersByCongress(congress, offset, limit, fromDateTime, toDateTime, currentMember, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CongressApi.getMembersByCongress']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Get congress member list by state code. Supports query parameters for filtering. 
         ...
         * @throws {RequiredError}
         */
        async getMembersByState(stateCode: string, offset?: number, limit?: number, fromDateTime?: string, toDateTime?: string, currentMember?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CongressMemberListResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getMembersByState(stateCode, offset, limit, fromDateTime, toDateTime, currentMember, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CongressApi.getMembersByState']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Get congress member list by state code and district. Supports query parameters for filtering. 
...
export const CongressApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Get congress member list by congress number. Supports query parameters for filtering. 
         * @summary Returns a list of congressional members by congress number.
         * @param {CongressApiGetMembersByCongressRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getMembersByCongress(requestParameters: CongressApiGetMembersByCongressRequest, options?: RawAxiosRequestConfig): AxiosPromise<CongressMemberListResponse> {
            return localVarFp.getMembersByCongress(requestParameters.congress, requestParameters.offset, requestParameters.limit, requestParameters.fromDateTime, requestParameters.toDateTime, requestParameters.currentMember, options).then((request) => request(axios, basePath));
        },
        /**
         * Get congress member list by state code. Supports query parameters for filtering. 
         * @summary Returns a list of congressional members by state code.
         * @param {CongressApiGetMembersByStateRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getMembersByState(requestParameters: CongressApiGetMembersByStateRequest, options?: RawAxiosRequestConfig): AxiosPromise<CongressMemberListResponse> {
            return localVarFp.getMembersByState(requestParameters.stateCode, requestParameters.offset, requestParameters.limit, requestParameters.fromDateTime, requestParameters.toDateTime, requestParameters.currentMember, options).then((request) => request(axios, basePath));
        },
        /**
         * Get congress member list by state code and district. Supports query parameters for filtering. 
         * @summary Returns a list of congressional members by state code and district.
...
/**
 * Request parameters for getMembersByCongress operation in CongressApi.
 * @export
 * @interface CongressApiGetMembersByCongressRequest
 */
export interface CongressApiGetMembersByCongressRequest {
    /**
     * The member\&#39;s congress number (e.g., 118 for the 118th Congress, 2023-2025)
     * @type {number}
     * @memberof CongressApiGetMembersByCongress
     */
 ...
 */
export interface CongressApiGetMembersByStateRequest {
    /**
     * The member\&#39;s state code (pattern: ^[A-Z]{2}$).
     * @type {string}
     * @memberof CongressApiGetMembersByState
     */
...
export class CongressApi extends BaseAPI {
     ...
     * @memberof CongressApi
     */
    public getMembersByCongress(requestParameters: CongressApiGetMembersByCongressRequest, options?: RawAxiosRequestConfig) {
        return CongressApiFp(this.configuration).getMembersByCongress(requestParameters.congress, requestParameters.offset, requestParameters.limit, requestParameters.fromDateTime, requestParameters.toDateTime, requestParameters.currentMember, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof CongressApi
     */
    public getMembersByState(requestParameters: CongressApiGetMembersByStateRequest, options?: RawAxiosRequestConfig) {
        return CongressApiFp(this.configuration).getMembersByState(requestParameters.stateCode, requestParameters.offset, requestParameters.limit, requestParameters.fromDateTime, requestParameters.toDateTime, requestParameters.currentMember, options).then((request) => request(this.axios, this.basePath));
    }
